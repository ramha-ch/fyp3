...
class RGDetailsPage extends StatefulWidget {
  final String glassImage;

  RGDetailsPage({required this.glassImage});

  @override
  _RGDetailsPageState createState() => _RGDetailsPageState();
}

class _RGDetailsPageState extends State<RGDetailsPage> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Elevate your style with our exquisite Round glasses collection. Experience fashion-forward eyewear with unmatched quality.',

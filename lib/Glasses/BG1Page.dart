...
class BGDetailsPage extends StatefulWidget {
  final String glassImage;

  BGDetailsPage({required this.glassImage});

  @override
  _BGDetailsPageState createState() => _BGDetailsPageState();
}

class _BGDetailsPageState extends State<BGDetailsPage> {
